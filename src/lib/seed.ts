  ...
  const seedDemands: Demand[] = [
    {
      ...
      location: 'Kaduna', deadline: '', buyerId: 'seed-buyer', buyerName: 'Emeka Supermarket',
    ...
    },
    {
      ...
      location: 'Oyo', deadline: '', buyerId: 'seed-buyer2', buyerName: 'Tunde Ayinde',
    ...
    },
    {
      ...
      location: 'Lagos', deadline: '', buyerId: 'seed-buyer3', buyerName: 'GreenFarm Lagos',
    ...
    },
    {
      ...
      location: 'Ibadan', deadline: '', buyerId: 'seed-buyer4', buyerName: 'Bola Adewale',
      responses: [], status: 'open', createdAt: new Date(Date.now() - 86400000).toISOString(),
    },
  ];
